package com.bcebhagalpur.CheAshu.shopfragment
...
class ShowroomShopFragment : Fragment() {
    ...
    private fun getUser() {
        ...
        val anotherChild = child.child("SHOP OR SHOWROOM")
        val anotherChild1=anotherChild.child("SHOWROOM AND SHOP BOTH")
