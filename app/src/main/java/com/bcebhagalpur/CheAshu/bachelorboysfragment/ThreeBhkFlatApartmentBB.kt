package com.bcebhagalpur.CheAshu.bachelorboysfragment
...
class ThreeBhkFlatApartmentBB : Fragment() {
...
searchCity()
    ...
    private fun getUser() {
        ...
        val anotherChild = child.child("BACHELOR ONLY FOR BOYS")
        val anotherChild1=anotherChild.child("3 BHK FLAT IN APARTMENT")
